        ...
        <div className="max-w-3xl w-full space-y-4 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-2xl my-16">
              ...
              <div className="flex items-center justify-between text-xs px-1">
                <div className="flex items-center">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="h-3 w-3 text-jansaathi-royalBlue focus:ring-jansaathi-royalBlue border-gray-300 dark:border-gray-700 rounded"
                  />
                  <label htmlFor="rememberMe" className="ml-2 block text-xs text-gray-900 dark:text-gray-300">
                    Remember me
                  </label>
                </div>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              ...
              <a href="/register" className="font-medium text-jansaathi-royalBlue dark:text-jansaathi-saffronOrange hover:text-jansaathi-royalBlue/80 dark:hover:text-jansaathi-saffronOrange/80">
                Register here
              </a>
            </p>
          </div>
